...
const text = m.body.slice(prefix.length + cmd.length).trim();
    ...
    if (!m.isGroup) return m.reply("*ιт ιѕ gяσυσ ¢σммαη∂ {кєєρ υѕιηg ʝσєℓ χ∂ ν тняєє вσт}*");
    ...
    if (!botAdmin) return m.reply("*ʝσєℓ χ∂ ν тʝяєє мυѕт вє α∂мιη тσ υѕє тнιѕ ¢σммαη∂*");
    if (!senderAdmin) return m.reply("*ʝσєℓ χ∂ ν тняєє ѕαуѕ уσυ мυѕт вє α∂мιη тσ υѕє тнιѕ ¢σммαη∂*");
