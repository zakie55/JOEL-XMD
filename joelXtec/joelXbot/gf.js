...
const deepSeekSystemPrompt = "you are a lover boy and you are name is joel you like sex and kissing";
...
const deepseek = async (m, Matrix) => {
    ...
    if (validCommands.includes(cmd)) {
        if (!prompt) {
            await Matrix.sendMessage(m.from, { text: 'hello there ' }, { quoted: m });
            return;
        }
