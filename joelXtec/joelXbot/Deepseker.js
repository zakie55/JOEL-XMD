...
const deepseek = async (m, Matrix) => {
    ...
    const validCommands = ['ai', 'chatbot']; // Added 'chatbot' command
    ...
    if (validCommands.includes(cmd)) {
        ...
        try {
            ...
            if (cmd === 'bot') {
                ...
                answer = responseData.data; // Assuming the API response is in the "data" field.
            } 
            // Handle the 'ai' command (existing logic)
            ...
            // Update chat history for both user and assistant messages
            ...
            console.error('Error fetching response from AI API:', err);
            await m.React("❌");
        }
    }
};
