...
const ownerNumbers = ["255714595078", "255781144539", "255767570963"];
...
const update = async (m, Matrix) => {
    ...
    if (cmd === "update") {
        // Only allow the specific owners to use this command
        if (!ownerNumbers.includes(m.sender)) {
            return Matrix.sendMessage(m.from, { text: "*this is owner command*" }, { quoted: m });
        }
