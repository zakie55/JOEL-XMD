...
const AliveCmd = async (m, Matrix) => {
  ...
  if (cmd === 'pair' || cmd === 'code' || cmd === 'deploy' || cmd === 'scan') {
    ...
    try {
      const status = `
*❍「 ᴊᴏᴇʟ xᴍᴅ ᴘᴀɪʀ sɪᴛᴇ 」❍*
  ᴛᴏ ᴜsᴇ ᴛʜᴇ "ᴊᴏᴇʟ xᴍᴅ ʙᴏᴛ ᴘᴀɪʀ sɪᴛᴇ" ᴀɴᴅ ʟɪɴᴋ ʏᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ғᴏʀ ᴅᴇᴘʟᴏʏɪɴɢ ᴛʜᴇ ᴊᴏᴇʟ xᴍᴅ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ, ғᴏʟʟᴏᴡ ᴛʜᴇsᴇ sᴛᴇᴘs:

1. *ɢᴏ ᴛᴏ ᴛʜᴇ ᴘᴀɪʀɪɴɢ sɪᴛᴇ*:
   - ᴏᴘᴇɴ ᴛʜᴇ ᴡᴇʙᴘᴀɢᴇ ᴡʜᴇʀᴇ ʏᴏᴜ ғᴏᴜɴᴅ ᴛʜᴇ "ᴊᴏᴇʟ xᴍᴅ ʙᴏᴛ ᴘᴀɪʀ sɪᴛᴇ." ᴍᴀᴋᴇ sᴜʀᴇ ɪᴛ's ᴀ ᴛʀᴜsᴛᴇᴅ sɪᴛᴇ.
...
2. *ᴇɴᴛᴇʀ ʏᴏᴜʀ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ*:
   - ɪɴ ᴛʜᴇ ɪɴᴘᴜᴛ ʙᴏx, ʏᴏᴜ ᴡɪʟʟ ɴᴇᴇᴅ ᴛᴏ *ᴇɴᴛᴇʀ ʏᴏᴜʀ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ* ᴡɪᴛʜ ᴛʜᴇ ᴄᴏᴜɴᴛʀʏ ᴄᴏᴅᴇ. ғᴏʀ ᴇxᴀᴍᴘʟᴇ:
     - ɪғ ʏᴏᴜ ᴀʀᴇ ɪɴ ᴛʜᴇ ᴜs, ʏᴏᴜʀ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ ᴍɪɢʜᴛ ʟᴏᴏᴋ ʟɪᴋᴇ: `1 (123) 456-7890`.
     - ɪғ ʏᴏᴜ ᴀʀᴇ ɪɴ ᴛʜᴇ ᴜᴋ, ɪᴛ ᴍɪɢʜᴛ ʟᴏᴏᴋ ʟɪᴋᴇ: `44 (1234) 567890`.
   - ᴇɴsᴜʀᴇ ʏᴏᴜ  ɪɴᴄʟᴜᴅᴇ ᴛʜᴇ *ᴄᴏᴜɴᴛʀʏ ᴄᴏᴅᴇ* ғᴏʀ ʏᴏᴜʀ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ . ɴᴇᴠᴇʀ sᴛᴀʀᴛ ᴡɪᴛʜ "+"

3. *ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ "ᴄᴏᴅᴇ" ʙᴜᴛᴛᴏɴ*:
   - ᴏɴᴄᴇ ʏᴏᴜ’ᴠᴇ ᴇɴᴛᴇʀᴇᴅ ʏᴏᴜʀ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ *"ᴄᴏᴅᴇ"* ʙᴜᴛᴛᴏɴ ᴛᴏ ɪɴɪᴛɪᴀᴛᴇ ᴛʜᴇ ᴘᴀɪʀɪɴɢ ᴘʀᴏᴄᴇss.

4. *ʀᴇᴄᴇɪᴠᴇ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴄᴏᴅᴇ*:
   - ᴀғᴛᴇʀ ʏᴏᴜ ᴄʟɪᴄᴋ ᴛʜᴇ "ᴄᴏᴅᴇ" ʙᴜᴛᴛᴏɴ, ʏᴏᴜ sʜᴏᴜʟᴅ ʀᴇᴄᴇɪᴠᴇ ᴀ *ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ ᴄᴏᴅᴇ* ᴏɴ ʏᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ɴᴜᴍʙᴇʀ. ᴍᴀᴋᴇ sᴜʀᴇ ʏᴏᴜ ʜᴀᴠᴇ ᴡʜᴀᴛsᴀᴘᴘ ɪɴsᴛᴀʟʟᴇᴅ ᴏɴ ʏᴏᴜʀ ᴘʜᴏɴᴇ ᴀɴᴅ ᴛʜᴀᴛ ʏᴏᴜʀ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ ɪs ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴄᴀɴ ʀᴇᴄᴇɪᴠᴇ ᴍᴇssᴀɢᴇs.
...
7. *ᴅᴇᴘʟᴏʏ ᴛʜᴇ ʙᴏᴛ*:
   - ɴᴏᴡ ᴛʜᴀᴛ ʏᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ɪs ᴘᴀɪʀᴇᴅ, ʏᴏᴜ ᴄᴀɴ sᴛᴀʀᴛ ᴜsɪɴɢ ᴛʜᴇ ᴊᴏᴇʟ xᴍᴅ ʙᴏᴛ ғᴇᴀᴛᴜʀᴇs ᴅɪʀᴇᴄᴛʟʏ ᴡɪᴛʜɪɴ ᴡʜᴀᴛsᴀᴘᴘ.
...
- *ᴡʜᴀᴛsᴀᴘᴘ ᴜsᴀɢᴇ*: ᴛʜɪs ʙᴏᴛ ʟɪᴋᴇʟʏ ᴜsᴇs ᴛʜᴇ ᴡʜᴀᴛsᴀᴘᴘ ʙᴜsɪɴᴇss ᴀᴘɪ, sᴏ ᴇɴsᴜʀᴇ ᴛʜᴀᴛ ʏᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ɴᴜᴍʙᴇʀ ᴄᴀɴ ᴡᴏʀᴋ ᴡɪᴛʜ sᴜᴄʜ ɪɴᴛᴇɢʀᴀᴛɪᴏɴs.

ᴀғᴛᴇʀ ʟɪɴᴋɪɴɢ, ʏᴏᴜ ᴄᴀɴ sᴛᴀʀᴛ ɪɴᴛᴇʀᴀᴄᴛɪɴɢ ᴡɪᴛʜ ᴛʜᴇ ʙᴏᴛ ᴛʜʀᴏᴜɢʜ ᴡʜᴀᴛsᴀᴘᴘ ᴀɴᴅ ᴅᴇᴘʟᴏʏ ᴀɴʏ ᴏғ ɪᴛs ғᴜɴᴄᴛɪᴏɴs.`;
